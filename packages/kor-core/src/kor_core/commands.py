...
class CommandRegistry(SearchableRegistry[Command]):
    """
    Central registry for slash commands using unified SearchableRegistry base.
    
    Provides command registration, lookup, and search functionality.
    Inherits pluggable search backends (regex, bm25) from SearchableRegistry.
    """
    ...
    def __contains__(self, name: str) -> bool:
        return name.lstrip("/") in self._items
